...
export interface PiDesktopApi {
  ...
  setDefaultThinkingLevel(
    workspaceId: string,
    thinkingLevel: import("@pi-gui/session-driver/runtime-types").RuntimeSettingsSnapshot["defaultThinkingLevel"],
  ...
  setSessionThinkingLevel(
    workspaceId: string,
    sessionId: string,
    thinkingLevel: NonNullable<import("@pi-gui/session-driver/runtime-types").RuntimeSettingsSnapshot["defaultThinkingLevel"]>,
  ): Promise<DesktopAppState>;
  ...
  getSessionTree(target: WorkspaceSessionTarget): Promise<import("@pi-gui/session-driver/types").SessionTreeSnapshot>;
  navigateSessionTree(
    target: WorkspaceSessionTarget,
    targetId: string,
    options?: import("@pi-gui/session-driver/types").NavigateSessionTreeOptions,
  ): Promise<{ readonly state: DesktopAppState; readonly result: import("@pi-gui/session-driver/types").NavigateSessionTreeResult }>;
